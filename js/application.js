...
tableau.extensions.initializeAsync().then(function () {
  ...
  */
            ...
            if(data[i][6].value == "BANKER"){
              Banker += data[i][8].formattedValue;
            }else if (data[i][6].value == "PLAYER"){
              Player += data[i][8].formattedValue;
            }
          ...
          const rowObj = {
            ...
            //  UserName: data[i][4].value,
              ...
              TableId: data[i][5].value,
              BetPosition: data[i][6].formattedValue,
              Currency: data[i][7].value,
              Amount: data[i][8].value,
              Net: data[i][9].formattedValue,
              UniqueGroup: "no",
